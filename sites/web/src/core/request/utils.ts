 ...
 */
export function makeGetReq(options?: any): RequestInit {
 ...
 */
export function makePostReq(body?: any, options?: any): RequestInit {
 ...
 */
export function makePatchReq(body?: any, options?: any): RequestInit {
 ...
 */
export function makeDeleteReq(options?: any): RequestInit {
